    ...
    <div className={styles.layout}>
      ...
      <div className={styles.githubPage}>
        ...
        <ul className={styles.goalsList}>
          ...
          <li>🚀 Master container orchestration with **Kubernetes**</li>
          <li>🔬 Explore **Edge AI** and real-time object detection</li>
          <li>🕶️ Release an **AR/VR simulation** for engineering education</li>
          <li>🤝 Collaborate in more **Open Source** and **Hackathons**</li>
        </ul>
